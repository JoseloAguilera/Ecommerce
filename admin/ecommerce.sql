...
-- Volcando datos para la tabla ecommerce.tb_cliente: 24 rows
...
-- Volcando datos para la tabla ecommerce.tb_producto: 249 rows
...
INSERT INTO `tb_producto` (`id`, `referencia`, `nombre`, `descripcion`, `valor_minorista`, `valor_mayorista`, `id_marca`, `destaque`, `activo`, `total_hits`, `unique_hits`) VALUES
	...
	(25, '9999', 'Kepi Cowboy', 'Quepis Rosa Cowboy', 160000, 120000, 5, 1, 1, 22, 17),
	...
	(81, 'BN273SCD', 'Kepi Medalla San Benito - Rojo', '', 160000, 120000, 5, 1, 1, 21, 21),
...
-- Volcando datos para la tabla ecommerce.tb_producto_categoria: 250 rows
...
-- Volcando datos para la tabla ecommerce.tb_usuario_cliente: 24 rows
