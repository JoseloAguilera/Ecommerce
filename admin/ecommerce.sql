...
-- Volcando estructura para tabla ecommerce.cms
...
-- Volcando datos para la tabla ecommerce.cms: 3 rows
...
-- Volcando datos para la tabla ecommerce.tb_atributo: 6 rows
...
-- Volcando datos para la tabla ecommerce.tb_atr_valor: 25 rows
...
-- Volcando datos para la tabla ecommerce.tb_banner: 5 rows
...
-- Volcando datos para la tabla ecommerce.tb_categoria: 17 rows
...
-- Volcando datos para la tabla ecommerce.tb_ciudad: ~172 rows (aproximadamente)
...
-- Volcando datos para la tabla ecommerce.tb_cliente: 25 rows
...
INSERT INTO `tb_cliente` (`id`, `nombre`, `apellido`, `ruc`, `documento`, `razon_social`, `mayorista`, `telefono`, `email`, `url`) VALUES
	...
	(25, 'Jose', 'Aguilera', NULL, NULL, NULL, 0, NULL, NULL, NULL);
...
-- Volcando datos para la tabla ecommerce.tb_cli_direccion: 6 rows
...
-- Volcando datos para la tabla ecommerce.tb_departamento: ~19 rows (aproximadamente)
...
-- Volcando datos para la tabla ecommerce.tb_marca: 8 rows
...
-- Volcando datos para la tabla ecommerce.tb_met_envio_costo: ~172 rows (aproximadamente)
...
INSERT INTO `tb_met_envio_costo` (`id`, `id_met_envio`, `id_ciudad`, `precio`, `tiempo_entrega`) VALUES
	...
	(98, 1, 98, 40000, '48hs'),
	(99, 1, 99, 40000, '48hs'),
	(100, 1, 100, 40000, '48hs'),
	(101, 1, 101, 40000, '48hs'),
	(102, 1, 102, 30000, '48hs'),
	(103, 1, 103, 40000, '48hs'),
	(104, 1, 104, 40000, '48hs'),
	(105, 1, 105, 40000, '48hs'),
	(106, 1, 106, 40000, '48hs'),
	(107, 1, 107, 40000, '48hs'),
	(108, 1, 108, 40000, '48hs'),
	(109, 1, 109, 30000, '48hs'),
	(110, 1, 110, 30000, '48hs'),
	(111, 1, 111, 25500, '48hs'),
	(112, 1, 112, 30000, '48hs'),
	(113, 1, 113, 25500, '48hs'),
	(114, 1, 114, 30000, '48hs'),
	(115, 1, 115, 25500, '48hs'),
	(116, 1, 116, 30000, '48hs'),
	(117, 1, 117, 40000, '48hs'),
	(118, 1, 118, 25500, '48hs'),
	(119, 1, 119, 40000, '48hs'),
	(120, 1, 120, 40000, '48hs'),
	(121, 1, 121, 40000, '48hs'),
	(122, 1, 122, 25500, '48hs'),
	(123, 1, 123, 30000, '48hs'),
	(124, 1, 124, 40000, '48hs'),
	(125, 1, 125, 25500, '48hs'),
	(126, 1, 126, 40000, '48hs'),
	(127, 1, 127, 40000, '48hs'),
	(128, 1, 128, 25500, '48hs'),
	(129, 1, 129, 30000, '48hs'),
	(130, 1, 130, 4000, '48hs'),
	(131, 1, 131, 40000, '48hs'),
	(132, 1, 132, 40000, '48hs'),
	(133, 1, 133, 40000, '48hs'),
	(134, 1, 134, 30000, '48hs'),
	(135, 1, 135, 30000, '48hs'),
	(136, 1, 136, 30000, '48hs'),
	(137, 1, 137, 40000, '48hs'),
	(138, 1, 138, 40000, '48hs'),
	(139, 1, 139, 40000, '48hs'),
	(140, 1, 140, 40000, '48hs'),
	(141, 1, 141, 40000, '48hs'),
	(142, 1, 142, 30000, '48hs'),
	(143, 1, 143, 40000, '48hs'),
	(144, 1, 144, 30000, '48hs'),
	(145, 1, 145, 40000, '48hs'),
	(146, 1, 146, 30000, '48hs'),
	(147, 1, 147, 40000, '48hs'),
	(148, 1, 148, 30000, '48hs'),
	(149, 1, 149, 40000, '48hs'),
	(150, 1, 150, 30000, '48hs'),
	(151, 1, 151, 30000, '48hs'),
	(152, 1, 152, 40000, '48hs'),
	(153, 1, 153, 30000, '48hs'),
	(154, 1, 154, 40000, '48hs'),
	(155, 1, 155, 40000, '48hs'),
	(156, 1, 156, 30000, '48hs'),
	(157, 1, 157, 30000, '48hs'),
	(158, 1, 158, 40000, '48hs'),
	(159, 1, 159, 40000, '48hs'),
	(160, 1, 160, 40000, '48hs'),
	(161, 1, 161, 40000, '48hs'),
	(162, 1, 162, 40000, '48hs'),
	(163, 1, 163, 40000, '48hs'),
	(164, 1, 164, 40000, '48hs'),
	(165, 1, 165, 40000, '48hs'),
	(166, 1, 166, 40000, '48hs'),
	(167, 1, 167, 40000, '48hs'),
	(168, 1, 168, 40000, '48hs'),
	(169, 1, 169, 30000, '48hs'),
	(170, 1, 170, 40000, '48hs'),
	(171, 1, 171, 40000, '48hs'),
	(172, 1, 172, 20000, '48hs');
...
-- Volcando datos para la tabla ecommerce.tb_pedido: 86 rows
...
-- Volcando datos para la tabla ecommerce.tb_ped_detalle: 97 rows
...
-- Volcando datos para la tabla ecommerce.tb_producto: 251 rows
/*!40000 ALTER TABLE `tb_producto` DISABLE KEYS */;
INSERT INTO `tb_producto` (`id`, `referencia`, `nombre`, `descripcion`, `valor_minorista`, `valor_mayorista`, `id_marca`, `destaque`, `por_pedido`, `activo`, `total_hits`, `unique_hits`) VALUES
	(85, 'BN199SCD', 'Kepi Aparecida - Bege', '', 160000, 120000, 5, 0, 1, 1, 1, 1),
	(25, '9999', 'Kepi Cowboy', 'Quepis Rosa Cowboy', 160000, 120000, 5, 1, 0, 1, 22, 17),
	(274, 'CP04', 'Guampa Inoxidable ', 'Guampa Inoxidable grabado a láser personalizado \r\n', 120000, 90000, 9, 0, 0, 1, 0, 0),
	(24, '8888', 'Kepi Celeste', 'Quepis celeste con detalles alrededor, logo en frente color negro\r\n', 160000, 120000, 6, 1, 0, 1, 26, 19),
	(23, '7777', 'Kepi Rojo', 'Quepis Rojo con logo negro, y malla red en parte trasera', 160000, 120000, 6, 1, 0, 1, 21, 17),
	(81, 'BN273SCD', 'Kepi Medalla San Benito - Rojo', '', 160000, 120000, 5, 1, 0, 1, 21, 21),
	(22, '6666', 'Kepi Camuflaje', 'Quepis con diseño camuflaje - malla trasera red', 160000, 120000, 5, 1, 0, 1, 13, 13),
	(87, 'BN256SCD', 'Kepi - Trator nuevo - Bege e Marom', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(20, '4444', 'Kepi Pescador Blanco', 'Quepis color blanco con estampa de pescado en la frente', 160000, 120000, 5, 1, 0, 1, 26, 25),
	(19, '3333', 'Kepi detalle Cruz', 'Quepis color negro en tela transpirable con detalle en la frente de Cruz en color dorado', 160000, 120000, 7, 1, 0, 1, 45, 41),
	(18, '2222', 'Kepi Azul - Logo Rojo', 'Quepis color azul con detalles rojos en el logo, y tela de malla en la parte trasera', 160000, 120000, 5, 1, 0, 1, 45, 22),
	(17, '1111', 'Kepi Negro con Detalles', 'Quepis Negro con Detalles en todo el exterior', 160000, 120000, 6, 1, 0, 1, 20, 16),
	(271, 'CP01', 'Guampa Inox + bombilla ', 'Guampa de terer inoxidable grabado a láser personalizada ', 160000, 120000, 9, 0, 0, 1, 1, 1),
	(272, 'CP02', 'Gampa Inoxidable + bombilla', 'Guampa Inoxidable grabado a láser personalizado \r\n', 160000, 120000, 9, 0, 0, 1, 2, 2),
	(273, 'CP03', 'Guampa Inoxidable + bombilla', 'Guampa Inoxidable grabado a láser personalizado \r\nPersonalize como quieres ', 160000, 120000, 9, 0, 0, 1, 1, 1),
	(36, 'BN281SCD', 'Kepi SCD Estilizado -Negro ', 'Edt referente.', 160000, 120000, 5, 1, 0, 1, 103, 90),
	(286, 'CP11', 'Guampa inoxdable + bombilla ', '', 160000, 120000, 9, 0, 0, 1, 1, 1),
	(38, 'BN112SCD', 'KEPI SACUDIDO´S - SUEDE BORDÔ', '', 160000, 120000, 5, 1, 0, 1, 38, 13),
	(275, 'CP05', 'Guampa Inoxidable + bombilla', 'Guampa Inoxidable grabado a láser personalizado \r\n', 160000, 120000, 9, 0, 0, 1, 1, 1),
	(40, 'BLFS-013', 'Remeras San Benedito ', '', 110000, 149000, 5, 0, 0, 0, 11, 8),
	(41, ' BN264SCD', 'Kepis Boi SCD- Rojo', '', 160000, 120000, 5, 0, 0, 1, 5, 5),
	(42, ' BN166SCD', 'Kepi Maron- Trator', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(44, 'BN205INF', 'Kepi Medalla San Benito ', '', 160000, 120000, 5, 0, 0, 1, 6, 2),
	(45, 'BN266SCD', 'kepi Boi Estilizado- Veludo Marom ', '', 160000, 120000, 5, 0, 0, 1, 5, 3),
	(47, 'BN225SCD', 'Kepi Pescador Camuflado ', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(48, 'BN188SCD', 'Kepi Cria, Recria e Engorda -Negro', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(49, ' BN240SCD', 'Kepi Medalla de San Benito - Verde Musgo', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(50, ' BN164SCD', 'Kepi- Arar, Semear y Cosechar - Branco y Verde', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(56, 'BN202SCD', 'Kepi Pecaria Lechera- Negro/ Vino ', '', 160000, 120000, 5, 1, 0, 1, 7, 6),
	(54, 'BN208SCD', 'Kepi-  Si vas a llorar - Azul /Marrom', '', 160000, 120000, 5, 1, 0, 1, 8, 8),
	(55, 'BN291SCD', 'Kepi Camionero - Gris', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(57, 'BN17BNM', 'kepi -Negro- Bruto Aba Suede', '', 160000, 120000, 10, 0, 0, 1, 3, 3),
	(58, 'BN263SCD', 'Kepi - Boi SCD - Negro', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(61, 'BN47SCD', 'Kepi Trucker Lan Azul y Tela Bege con Detalles Bordado en la parte frontal', '', 160000, 120000, 5, 0, 0, 1, 7, 2),
	(62, 'BN237SCD', 'Kepi Medalla de San Benito - Vino ', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(63, 'BN220SCD', 'Kepi Touro - Vino', '', 160000, 120000, 5, 0, 0, 1, 0, 0),
	(64, 'BN234SCD', 'Kepi Vida Sertaneja - Vino', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(66, 'BN177SCD', 'Kepi - Aviador - Azul / Marom', '', 160000, 120000, 5, 0, 0, 1, 3, 3),
	(69, 'BN09BNM', 'KEPI Bão Nu Mundo Arame Bege', '', 160000, 120000, 10, 0, 0, 1, 1, 1),
	(178, 'BN276SCD', 'Kepi Logo Matelasse - Negro / Bege', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(86, 'BN217INF', 'Kepi Medalla San Benito - Azul Marino ', '', 160000, 120000, 5, 0, 0, 1, 0, 0),
	(76, 'BN123SCD-GG', 'Kepi- Menos Modinha Mais Modão - Tamanho Especial', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(88, 'BN251SCD', 'Kepi - Boi Estilizado - Gris /Vde Neon', '', 160000, 120000, 5, 0, 0, 1, 3, 3),
	(89, 'BN252SCD', 'Kepi Logo - Negro / Verde', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(90, 'BN269SCD', 'Kepi cerado - SCD - Gris / Verde Neon', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(91, 'BN222SCD', 'Kepi Rodeo - Metelassê Marrom', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(92, 'BN175SCD', 'Kepi - Cria, Recria e Engorda - Vino', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(93, 'BN172SCD', 'Kepi- Camionero - Lona', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(94, 'BN260SCD', 'Kepi - Tambor - Gris e Rosa', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(95, 'BN47SCD', 'Kepi Trucker Lan Azul e Tela Bege con Detalles Bordado frontal', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(96, 'BN223SCD', 'Kepi Pescador - Azul Marino', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(98, 'BN247SCD', 'Kepi- San Jorge - Marino / Laranja', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(99, 'BN245SCD', 'Kepi - Logomarca - Negro / Tiera', '', 160000, 120000, 5, 0, 0, 1, 0, 0),
	(100, 'BN233SCD', 'Kepi Boi Estilizado - Negro y Verde', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(161, 'BN243SCD', 'Kepi- Boi Bco e Naranja - Azul Marino', '', 160000, 120000, 10, 0, 0, 1, 1, 1),
	(102, 'BN02BNM', 'Kepi Bão Nu Mundo - Gris e Marom con Aplique en Pastisol', '', 160000, 120000, 10, 0, 0, 1, 1, 1),
	(103, 'BN22BNM', 'Kepi Bão Nu Mundo - Bisão - Negro / Etnico', '', 160000, 120000, 10, 0, 0, 1, 3, 3),
	(104, 'BN26SCD', 'Kepi Trucker Azul e Jeans De Tela e Detalles Bordados', '', 160000, 120000, 5, 0, 0, 1, 0, 0),
	(105, 'BN285SCD', 'Kepi Caballo Deseñado - Naranja', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(107, 'BN183SCD', 'Kepi Caprinocultor - Marom', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(108, 'BN180SCD', 'Kepi Muares - Verde', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(109, 'BN242SCD', 'Kepi - Marrom / Natural', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(110, 'BN12BNM', 'Kepi Bão Nu Mundo -Frente Sublimada y Negro', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(111, 'BN06BNM', 'Kepi Bão Nu Mundo Jean Blanco y Vino', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(112, 'BN232SCD', 'Kepi Rodeo - Azul Marino', '', 160000, 120000, 5, 0, 0, 1, 0, 0),
	(113, 'BN235SCD', 'Kepi Logo - Amarillo ', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(114, 'BN33SCD', 'Kepi Azul, Blanco y Gris- Con Detalle Silkado', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(115, 'BN224SCD', 'Kepi Pescador - Gris', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(116, 'BN161SCD', 'Kepi - Café / Cafeicultor - Juta Bege', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(117, 'BN201SCD', 'Kepi Aparecida - Blanco', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(118, 'BN58INF', 'Kepi - Floral - Negro e Blanco Infantil', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(119, 'BN250SCD', 'Kepi - Boi Estilizado - Negro / Naranja', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(120, 'BN02INF', 'Kepi Trucker - Bege / Marom - Infantil', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(121, 'BN257SCD', 'Kepi- Tambor - Pink', '', 160000, 120000, 5, 0, 0, 1, 3, 3),
	(122, 'BN252SCD', 'Kepi- Logo - Negro / Verde', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(123, 'BN268SCD', 'Kepi - Etiqueta SCD - Marom / Cortiza', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(124, 'BN283SCD', 'Kepi Camioneiro - Negro ', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(125, 'BN262SCD', 'Kepi - Boi SCD - Azul Claro', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(126, 'BN288SCD', 'Kepi Caballo Deseñado - Gris / Deseño', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(127, 'BN286SCD', 'Kepi Plantación Huerta - Verde Musgo', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(128, 'BN284SCD', 'Kepi Pescador de Dourado - Gris', '', 160000, 120000, 5, 0, 0, 1, 0, 0),
	(129, 'BN259SCD', 'Kepi - Molinete - Vino', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(130, 'BN26BNM', 'Kepi Bão Nu Mundo - Cactos - Gris', '', 160000, 120000, 10, 0, 0, 1, 1, 1),
	(131, 'BN23BNM', 'Kepi Bão Nu Mundo - Texas Cactos - Bege Escuro', '', 160000, 120000, 10, 0, 0, 1, 1, 1),
	(132, 'BN253SCD', 'Kepi - Etiqueta - Gris / Naranja', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(133, 'BN248SCD', 'Kepi - San Jorge - Negro e Marom', '', 160000, 120000, 10, 0, 0, 1, 0, 0),
	(134, 'BN249SCD', 'Kepi - San Jorge - Blanco / Negro ', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(135, 'BN10BNM', 'Kepi Bão Nu Mundo Marrom y Rojo', '', 160000, 120000, 10, 0, 0, 1, 3, 3),
	(136, 'BN190SCD', 'KEpi Pequi - Bege / Vino', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(137, 'BN72SCD', 'Kepi - Tira Bordado - Marrón y Paja', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(138, 'BN16BNM', 'Kepi Bão Nu Mundo Beige y Negro - Suavemente Raso', '', 160000, 120000, 10, 0, 0, 1, 1, 1),
	(139, 'BN267SCD', 'Kepi - Boi Estilizado - Blanco/Rojo', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(141, 'BN13BNM', 'Kepi Bão Nu Mundo Jeans e Beige - Suavemente Raso', '', 160000, 120000, 10, 0, 0, 1, 0, 0),
	(142, 'BN229SCD', 'Kepi Viola Caipira - Negro ', '', 160000, 120000, 5, 0, 0, 1, 0, 0),
	(143, 'BN203SCD', 'Kepi Muladeiro - Negro ', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(144, 'BN200SCD', 'Kepi Aparecida - Vino', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(145, 'BN287SCD', 'Kepi SCD Boi - Azul / Naranja', '', 160000, 120000, 5, 0, 0, 1, 0, 0),
	(146, 'BN261SCD', 'Kepi - SCD Boi Estilizado - Marino', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(147, 'BN265SCD', 'Kepi - Pena - Roxo', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(148, 'BN11BNM', 'Kepi Bão Nu Mundo Rojo Azul e Blanco', '', 160000, 120000, 10, 0, 0, 1, 1, 1),
	(149, 'BN189SCD', 'Kepi Caña de Azúcar - Verde', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(150, 'BN07BNM', 'Kepi Bão Nu Mundo - Naranja, Café e Beige con Aplique en Pastisol', '', 160000, 120000, 10, 0, 0, 1, 0, 0),
	(151, 'BN290SCD', 'Kepi - Boi SCD - Gris e Naranja', '', 160000, 120000, 5, 0, 0, 1, 0, 0),
	(152, 'BN05BNM', 'Kepi Bão Nu Mundo Azul, Rojo e Blanco', '', 160000, 120000, 10, 0, 0, 1, 1, 1),
	(153, 'BN24BNM', 'Kepi Bão Nu Mundo - Índio - Vino', '', 160000, 120000, 10, 0, 0, 1, 1, 1),
	(154, 'BN20BNM', 'Kepi Bão Nu Mundo - Trucker Black', '', 160000, 120000, 10, 0, 0, 1, 1, 1),
	(155, 'BN258SCD', 'Kepi- Pena - Gris Mescla', '', 160000, 120000, 5, 0, 0, 1, 0, 0),
	(156, 'BN227SCD', 'Kepi Caballo - Marfim / Rum / Negro', '', 160000, 120000, 10, 0, 0, 1, 1, 1),
	(157, 'BN08BNM', 'Kepi Bão Nu Mundo Vino con Aplique en Laser', '', 160000, 120000, 10, 0, 0, 1, 1, 1),
	(158, 'BN85SCD-2', 'Kepi - Profición Veterinária - Beige', '', 160000, 120000, 10, 0, 0, 1, 1, 1),
	(159, 'BN211SCD', 'Kepi - Molinete - Negro / Gris', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(160, 'BN282SCD', 'Kepi Lenda del Rodeo - Tiera ', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(162, 'BN278SCD', 'Kepi- Sacudido´s Arame - Vino', '', 160000, 120000, 5, 0, 0, 1, 0, 0),
	(163, 'BN280SCD', 'Kepi Boi Estilizado - Azul/Rojo', '', 160000, 120000, 5, 0, 0, 1, 0, 0),
	(164, 'BN272SCD', 'Kepi - Quadrado - Azul / Diseño ', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(165, 'BN279SCD', 'Kepi Etiqueta SCD - Verde Musgo', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(166, 'BN197SCD', 'Kepi Touro Estilizado - Naranja', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(167, 'BN236SCD', 'Kepi Arame - Rojo', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(168, 'BN162SCD', 'Kepi - Produtor Rural - Marron e Verde', '', 160000, 120000, 10, 0, 0, 1, 2, 2),
	(169, 'BN206SCD', 'Kepi Medalla San Bento - Mostarda/Vino', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(170, 'BN198SCD', 'Kepi Aparecida - Negro', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(171, 'BN219SCD', 'Kepi Medalla de San Benito - Blanco', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(172, 'BN222SCD', 'Kepi Rodeo - Metelassê Marrom', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(173, 'BN221SCD', 'Kepi Matelassê - Negro e Amarillo', '', 160000, 120000, 10, 0, 0, 1, 1, 1),
	(174, 'BN83SCD', 'Kepi - Profición Agronomia - Café', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(175, 'BN254SCD', 'Kepi - SCD - Verde / Beige', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(176, 'BN124SCD', 'Kepi Tereré - Verde e Marrom', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(177, 'BN149SCD', 'Kepi - Chimarrão - Marrom, Verde e Bege', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(179, 'BN209SCD', 'Kepi Trucker Texturizado - Negro', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(180, 'BN195SCD', 'Kepi Trucker - Tiera', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(181, 'BN01BNMINF', 'Kepi Bão Nu Mundo Infantil - Vermelho, Cru e Azul com Aplique em Pastisol', '', 160000, 120000, 10, 0, 0, 1, 1, 1),
	(182, 'BN25BNM', 'Kepi Bão Nu Mundo - Cowboy - Caramelo', '', 160000, 120000, 10, 0, 0, 1, 1, 1),
	(183, 'BN264SCD', 'Kepi - Laço Comprido - Suede Gris', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(184, 'BN238SCD-GG', 'Kepi Medalla San Benito - Juta / Café-Tamaño Especial', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(185, 'BN04BNM', 'Kepi Bão Nu Mundo - Negro con Aplique en Pastisol', '', 160000, 120000, 10, 0, 0, 1, 2, 2),
	(186, 'BN01INF', 'Kepi - Vinoo e Bege - Infantil', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(187, 'BN184SCD', 'Kepi Touro Estilizado - Suede Chumbo Claro', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(188, 'BN99SCD', 'Kepi - Prof. Téc. Agropec. - Pto/Verde', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(189, 'BN40INF', 'Kepi - Trucker - Azul - Infantil', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(190, 'BN187SCD', 'Kepi Vaquejada - Azul Marino / Vino', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(191, 'BN77SCD', 'Kepi - Churrasqueiro - Marrom e Bege', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(192, 'BN174SCD', 'Kepi - Caça - Camuflado', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(193, 'BN113SCD', 'Kepi - Apl. Plastsol - Suede Azul Claro', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(194, 'BN90SCD', 'Kepi - Pescador - Bege / Vinho', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(195, 'BN75SCD', 'Kepi - Detalhe frente - Azul Vazado', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(196, 'BN186SCD', 'Kepi- Regulador Especial - Negro/Vino', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(197, 'BN117SCDINF', 'Kepi- Caminhon. Infantil - Marrom e Jeans', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(198, 'BN176SCD', 'Kepi - Sanfoneiro - Bege', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(199, 'BN165SCD', 'Kepi - Berranteiro - Verde / Marrom', '', 160000, 120000, 5, 0, 0, 1, 4, 4),
	(200, 'BN64SCD', 'Kepi - Aplique Plastisol - Vino', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(201, 'BN94SCD', 'Kepi - Trator - Amarillo y Negro', '', 160000, 120000, 5, 0, 0, 1, 0, 0),
	(202, 'BN274SCD', 'Kepi Medalla San Benito - Caramelo', '', 160000, 120000, 5, 0, 0, 1, 1, 1),
	(203, 'BN100SCD', 'Kepi - Trator - Rojo, Azul e Blanco', '', 160000, 120000, 5, 0, 0, 1, 2, 2),
	(204, 'CM01EDT', 'Remeras unisex Edt', 'Lanzamientos en remeras Edt del P al GG', 110000, 85000, 9, 1, 1, 1, 82, 27),
	(205, 'B1640', 'Kepi Made in Mato Black Icon', '', 160000, 120000, 8, 0, 0, 1, 1, 1),
	(206, 'B1625', 'Kepi Made in Mato Custom Negro', '', 160000, 120000, 8, 0, 0, 1, 1, 1),
	(207, 'B1768', 'Kepi Made in Mato Snappback Black Icon', '', 160000, 120000, 8, 0, 0, 1, 3, 1),
	(208, 'B1938', 'Kepi Trucker X Yellow', '', 160000, 120000, 8, 0, 0, 1, 1, 1),
	(209, 'B1728', 'Kepi Trucker Military Negro', '', 160000, 120000, 8, 0, 0, 1, 2, 2),
	(210, 'B1766', 'Kepi Trucker Flag', '', 160000, 120000, 8, 0, 0, 1, 1, 1),
	(214, 'B1770', 'Kepi Made in Mato Trucker Super Icon Negro', '', 160000, 120000, 8, 0, 0, 1, 1, 1),
	(212, 'B1749', 'kepi Trucker Scribble Military ', '', 160000, 120000, 8, 0, 0, 1, 1, 1),
	(213, 'B1502', 'Kepi Made In Mato Trucker Rooster', '', 160000, 120000, 8, 0, 0, 1, 1, 1),
	(215, 'B1747', 'Kepi Made in Mato Trucker Scribble Black', '', 160000, 120000, 8, 0, 0, 1, 1, 1),
	(216, 'B1746', 'Kepi Trucker vintage shield ', '', 160000, 120000, 8, 0, 0, 1, 2, 2),
	(217, 'B1664', 'Kepi Made in Mato quarto de milha', '', 160000, 120000, 8, 0, 0, 1, 1, 1),
	(218, 'B1736', 'Kepi Mde in Mato Trucker Old Rooster', '', 160000, 120000, 8, 0, 0, 1, 1, 1),
	(219, 'B1615', 'Kepi Made in Mato Trucker Black Rooster ', '', 160000, 120000, 8, 0, 0, 1, 1, 1),
	(220, 'B1697', 'Kepi Made in Mato Trucker American Rooster', 'Edición Ilimitada ', 160000, 120000, 8, 0, 0, 1, 2, 2),
	(221, 'B1767', 'Kepi Snapback American Rooster', '', 160000, 120000, 8, 0, 0, 1, 1, 1),
	(222, 'B1719', 'Kepi Made in Mato Trucker expansion black', '', 160000, 120000, 10, 0, 0, 1, 2, 2),
	(223, 'B1754', 'Kepi TRUCKER CHESS', '', 160000, 120000, 8, 0, 0, 1, 1, 1),
	(224, 'B1757', 'Kepi Trucker Fazendeiro', '', 160000, 120000, 8, 0, 0, 1, 1, 1),
	(225, 'B1616', 'Kepi Trucker Shield Red', '', 160000, 120000, 8, 0, 0, 1, 1, 1),
	(226, 'B1609', 'kepi Trucker Red Plate', '', 160000, 120000, 8, 0, 0, 1, 3, 3),
	(227, 'B1618', 'Kepi Trucker Black Shield ', '', 160000, 120000, 8, 0, 0, 1, 2, 2),
	(228, 'B1748', 'Kepi Snapback Scribble Skin ', '', 160000, 120000, 8, 0, 0, 1, 3, 3),
	(229, 'B1653', 'Kepi Trucker Manga Larga Machador Brown ', '', 160000, 120000, 8, 0, 0, 1, 1, 1),
	(230, 'B1608', 'Kepi Trucker Skin ', '', 160000, 120000, 8, 0, 0, 1, 1, 1),
	(231, 'B1752', 'Kepi Snapback logo icon ', '', 160000, 120000, 8, 0, 0, 1, 3, 3),
	(232, 'B1687', 'Kepi Trucker Cortica', '', 160000, 120000, 8, 0, 0, 1, 3, 3),
	(233, 'B1762', 'Kepi Trucker Under Skin ', '', 160000, 120000, 8, 0, 0, 1, 3, 3),
	(234, 'B1778', 'Kepi Trucker Furta Black ', '', 160000, 120000, 8, 0, 0, 1, 3, 3),
	(236, 'B1727', 'Kepi Trucker Black Tape ', '', 160000, 120000, 8, 0, 0, 1, 1, 1),
	(237, 'B1729', 'Kepi Trucker Brown', '', 160000, 120000, 8, 0, 0, 1, 2, 2),
	(238, 'B1610', 'Kepi Trucker Red Rooster ', '', 160000, 120000, 10, 0, 0, 1, 1, 1),
	(270, 'BN271SCD', 'Kepi- Boi Sacudido´s - Preto', '', 160000, 120000, 5, 0, 0, 1, 0, 0),
	(239, 'BN09', 'KEPI PREMIUM ABA CURVA - JEANS NEGRO', '', 160000, 120000, 6, 0, 0, 1, 0, 0),
	(240, 'BN1015', 'KEPI PREMIUM ABA CURVA - JEANS AZUL', '', 160000, 120000, 6, 0, 0, 1, 0, 0),
	(241, 'BN264', 'BONÉ ABA CURVA CHORABOY - DESTROYED JEANS ', '', 160000, 120000, 10, 0, 0, 1, 1, 1),
	(242, 'BN1016', 'KEPI PREMIUM ABA CURVA - BRILHANTE CHUMBO', '', 160000, 120000, 6, 0, 0, 1, 0, 0),
	(243, 'BN31', 'KEPI ABA CURVA - BRILHANTE ', '', 160000, 120000, 6, 0, 0, 1, 2, 2),
	(244, 'BN215', 'KEPI ABA CURVA - BRILHANTE ', '', 160000, 120000, 6, 0, 0, 1, 4, 2),
	(245, 'BN432', 'KEPI ABA CURVA CHORABOY - ROJO', '', 160000, 120000, 6, 0, 0, 1, 1, 1),
	(246, 'BN159', 'KEPI ABA CURVA TRUCKER CHORABOY - ROJO', '', 160000, 120000, 6, 0, 0, 1, 0, 0),
	(247, 'VDM53', 'Kepi Aba Curva Trucker - Eu Conheço meu Gado - Preto', '', 160000, 120000, 11, 0, 0, 1, 0, 0),
	(248, '867', 'KEPI RUSTIC', '', 160000, 120000, 7, 0, 0, 1, 0, 0),
	(249, '873', 'KEPI HORSE FLAG VERDE MUSGO', '', 160000, 120000, 7, 0, 0, 1, 1, 1),
	(250, '920', 'KEPI WREN AZUL MARINO', '', 160000, 120000, 7, 0, 0, 1, 0, 0),
	(251, '848', 'KEPI HORN AZUL MARINO', '', 160000, 120000, 7, 0, 0, 1, 1, 1),
	(252, '819', 'kEPI EXPLORE BF', '', 160000, 120000, 7, 0, 0, 1, 1, 1),
	(253, '879', 'KEPI ALAZÃO AZUL MARINHO COM CARAMELO', '', 160000, 120000, 7, 0, 0, 1, 2, 2),
	(254, '880', 'KEPI ALAZÃO BRANCO CON ROJO', '', 160000, 120000, 7, 0, 0, 1, 1, 1),
	(255, '874', 'KEPI HORSE CON ABA NARANJA ', '', 160000, 120000, 7, 0, 0, 1, 5, 5),
	(256, '882', 'KEPI ALAZÃO ROJO', '', 160000, 120000, 7, 0, 0, 1, 3, 3),
	(257, '864', 'KEPI VETERINÁRIA BLACK', '', 160000, 120000, 7, 0, 0, 1, 1, 1),
	(258, '821', 'KEPI AGRONOMIA NEGRO', '', 160000, 120000, 7, 0, 0, 1, 4, 4),
	(259, '921', 'KEPI WREN MESCLA CON NEGRO', '', 160000, 120000, 7, 0, 0, 1, 3, 2),
	(260, 'CHC02SCD', 'SOMBREO DE CUERO - NOBUCK MARROM', '', 280000, 210000, 5, 0, 0, 1, 2, 2),
	(261, 'CHC01SCD', 'Sombrero De Cuero - Croco Terra', '', 280000, 210000, 5, 0, 0, 1, 3, 2),
	(262, 'CHC09SCD', 'SOMBRERO - ESTILO CAMPEIRO - PALHA', '', 190000, 150000, 5, 0, 0, 1, 2, 2),
	(263, 'CH01SCD', 'SOMBRERO - ESTILO AMERICANO - PALHA', '', 190000, 150000, 5, 0, 0, 1, 2, 2),
	(264, 'CH03SCD', 'SOMBRERO- ESTILO PANTANEIRO - PAJA', '', 190000, 150000, 5, 0, 0, 1, 4, 3),
	(265, 'CH02SCD', 'SOMBRERO- ESTILO GOTA CLÁSSICO - PAJA', '', 190000, 120000, 5, 0, 0, 1, 2, 2),
	(266, 'CHAP01', 'SOMBRERO DE PAJA PIERSIDE CHORABOY', '', 170000, 130000, 6, 0, 0, 1, 1, 1),
	(267, 'CHAP05', 'SOMBRERO DE PAJA FLORAL CHORABOY ', '', 170000, 130000, 6, 0, 0, 1, 2, 2),
	(268, 'CHAP02', 'SOMBRERO DE PAJA FLORAL CHORABOY ', '', 170000, 130000, 6, 0, 0, 1, 1, 1),
	(269, 'CHAP03', 'SOMBRERO DE PAJA FLORAL CHORABOY ', '', 170000, 130000, 6, 0, 0, 1, 1, 1),
	(276, 'CP06', 'Guampa Inoxidable ', 'Guampa Inoxidable grabado a láser personalizado \r\n', 160000, 120000, 9, 0, 0, 1, 1, 1),
	(300, 'BN30BNM', 'Kepi Bão Nu Mundo - Cowgirl - Pink', '', 160000, 120000, 10, 0, 0, 1, 1, 1),
	(278, 'CP08', 'Guampa inoxidable ', 'Guampa Inoxidable grabado a láser personalizado \r\n', 120000, 90000, 9, 0, 0, 1, 1, 1),
	(279, 'CP09', 'Guampa inoxidable ', 'Guampa Inoxidable grabado a láser personalizado \r\n', 120000, 90000, 9, 0, 0, 1, 1, 1),
	(280, 'CP10', 'Guampa inoxidable ', 'Guampa Inoxidable grabado a láser personalizado \r\nGuampa personalizada ', 120000, 90000, 9, 0, 0, 1, 1, 1),
	(281, 'MT01', 'Matero ', 'Matero grabado a lázer personalizado ', 70000, 50000, 9, 0, 0, 1, 4, 4),
	(282, 'MT02', 'Matero ', 'Matero grabado a lázer personalizado ', 70000, 50000, 9, 0, 0, 1, 2, 2),
	(283, 'MT03', 'Matero ', 'Matero grabado a lázer personalizado ', 70000, 50000, 9, 0, 0, 1, 2, 2),
	(284, 'MT04', 'Matero', 'Matero grabado a lázer personalizado ', 70000, 50000, 9, 0, 0, 1, 2, 2),
	(285, 'MT05', 'Matero', 'Matero grabado a lázer personalizado como quieres ', 70000, 50000, 9, 0, 0, 1, 3, 3),
	(287, 'CP12', 'Guampa inoxidable + bombilla ', '', 160000, 120000, 9, 0, 0, 1, 1, 1),
	(288, 'CP13', 'Guampa inoxidable ', 'Guampa inoxidable grabada a lazer personalizada', 160000, 120000, 9, 0, 0, 1, 8, 8),
	(289, 'CP14', 'Guampa inoxidable ', 'Guampa inoxidable rezinada ', 190000, 150000, 9, 0, 0, 1, 8, 8),
	(290, 'CP15', 'Guampa inoxidable + bombilla', 'Guampa inoxidable rezinada ', 190000, 150000, 9, 0, 0, 1, 3, 3),
	(291, 'CP16', 'Guampa inoxidable + bombilla ', 'Guampa inoxidable rezinada ', 190000, 150000, 9, 0, 0, 1, 5, 5),
	(292, 'CP17', 'Guampa inoxidable + bombilla ', 'Guampa inoxidable rezinada ', 190000, 150000, 9, 0, 0, 1, 6, 6),
	(293, 'OC265', 'Óculos de Sol ChoraBoy - Masculino', '', 190000, 150000, 6, 0, 0, 1, 3, 3),
	(294, 'OC286', 'Óculos de Sol ChoraBoy - Masculino', '', 190000, 150000, 6, 0, 0, 1, 4, 4),
	(295, 'OC201', 'Óculos de Sol ChoraBoy - Masculino', '', 190000, 150000, 9, 0, 0, 1, 3, 3),
	(296, 'BN65', 'KEPI ABA CURVA CHORABOY - ROSÊ ', '', 160000, 120000, 6, 0, 0, 1, 5, 5),
	(297, 'BN1011', 'KEPI ABA CURVA RETRÔ - FERRUGEM ', '', 160000, 120000, 6, 0, 0, 1, 3, 3),
	(298, 'BN160', 'KEPI TRUCKER CHORABOY - PRETO E CARAMELO ', '', 160000, 120000, 6, 0, 0, 1, 3, 3),
	(299, 'BN70', 'KEPI ABA CURVA CHORABOY - CINZA CLARO ', '', 160000, 120000, 6, 0, 0, 1, 2, 2),
	(301, 'BN302SCD', 'Kepi  SCD Trator - Blanco / Marino', '', 160000, 120000, 5, 0, 0, 1, 7, 4),
	(303, 'BT003SCD', 'Botina B. Quad. Tradicional-Café / Rosa', '', 420000, 350000, 5, 0, 0, 1, 2, 2),
	(304, 'LS01', 'Dec. de Mate ', 'Decoración de mate ', 25000, 12000, 9, 0, 0, 1, 15, 2),
	(305, 'LS02', 'Llaveros de Soja ', '', 25000, 15000, 9, 0, 0, 1, 2, 1),
	(306, 'LS03', 'Llavero de Maiz ', '', 25000, 15000, 9, 0, 0, 1, 2, 1),
	(307, 'LS04', 'Llaveros de peces ', '', 25000, 15000, 9, 0, 0, 1, 1, 1),
	(308, 'BA01', 'Billetera Sacudidos ', '', 170000, 120000, 5, 0, 0, 1, 2, 2),
	(309, 'BA739', 'Billetera Feminina Couro - 739 -Elefante', '', 230000, 190000, 5, 0, 0, 1, 2, 2),
	(310, 'jose', 'remeraaaa', '', NULL, NULL, 6, 0, 1, 1, 24, 2),
	(311, 'jose1', 'Remeraaaa1', '', NULL, NULL, 10, 0, 1, 1, 0, 0);
...
-- Volcando datos para la tabla ecommerce.tb_producto_atributo: 9 rows
...
-- Volcando estructura para tabla ecommerce.tb_producto_atr_valor
...
-- Volcando datos para la tabla ecommerce.tb_producto_atr_valor: 28 rows
/*!40000 ALTER TABLE `tb_producto_atr_valor` DISABLE KEYS */;
INSERT INTO `tb_producto_atr_valor` (`id`, `id_atributo`, `id_atr_valor`, `activo`) VALUES
	...
	(31, 13, 13, 1),
	(32, 13, 33, 1);
/*!40000 ALTER TABLE `tb_producto_atr_valor` ENABLE KEYS */;
...
-- Volcando datos para la tabla ecommerce.tb_producto_categoria: 252 rows
...
-- Volcando estructura para tabla ecommerce.tb_producto_combinacion
...
-- Volcando datos para la tabla ecommerce.tb_producto_combinacion: 43 rows
/*!40000 ALTER TABLE `tb_producto_combinacion` DISABLE KEYS */;
INSERT INTO `tb_producto_combinacion` (`id_combinacion`, `id_producto_atr_valor`) VALUES
	...
	(25, 31),
	(26, 32);
/*!40000 ALTER TABLE `tb_producto_combinacion` ENABLE KEYS */;
...
-- Volcando datos para la tabla ecommerce.tb_producto_img: 925 rows
...
-- Volcando datos para la tabla ecommerce.tb_producto_stock: 105 rows
...
-- Volcando estructura para tabla ecommerce.tb_revendedor
...
-- Volcando datos para la tabla ecommerce.tb_revendedor: 24 rows
/*!40000 ALTER TABLE `tb_revendedor` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tb_revendedor` ENABLE KEYS */;
...
-- Volcando datos para la tabla ecommerce.tb_stock_valor: 8 rows
...
-- Volcando datos para la tabla ecommerce.tb_usuario_cliente: 25 rows
...
INSERT INTO `tb_usuario_cliente` (`id`, `id_cliente`, `email`, `email_verificado`, `contrasena`, `creado_en`) VALUES
	...
	(25, 25, 'joseaguilera1709@gmail.com', NULL, '427e1216df583c34634222f6ca00ef71', '2021-04-26');
...
-- Volcando datos para la tabla ecommerce.transactions: 21 rows
