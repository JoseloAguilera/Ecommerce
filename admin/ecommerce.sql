...
-- Volcando datos para la tabla ecommerce.tb_pedido: 36 rows
...
-- Volcando datos para la tabla ecommerce.tb_ped_detalle: 46 rows
...
INSERT INTO `tb_producto` (`id`, `referencia`, `nombre`, `descripcion`, `valor_minorista`, `valor_mayorista`, `id_marca`, `destaque`, `activo`, `total_hits`, `unique_hits`) VALUES
	...
	(12, '19', 'Quepis Made in Mato Negro + Marron 4x4', 'Quepis Made in Mato Negro Frente + Marrón Atrás con logo 4x4 ', 78650, 500000, 4, 1, 1, 5, 4),
