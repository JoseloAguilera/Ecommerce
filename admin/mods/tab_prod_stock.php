    ...
    <div class="box-body table-responsive">
        <table class="table table-striped table-bordered display nowra table-image" id="tabladatos2">
            ...
            <tbody>
                ...
                ?>
                <tr data-toggle="modal" data-target="#AltStockModal" data-codigo="<?php echo $row['id'];?>" data-valores="<?php echo $valorProd;?>" data-stock="<?php echo $row['stock'];?>" data-precio="<?php echo number_format($row['valor_minorista'], 0, ',', '.');?>" data-descuento="<?php echo number_format($row['valor_mayorista'], 0, ',', '.');?>">
                    <td>
                        <?php 
                            if ($row['id_combinacion'] == "") {
                                echo 'UNICO';
            ...
            <form action="" method="POST" autocomplete="off">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="valorminorista">Valor Minorista</label>
                                <input type="text" class="form-control" id="precio" name="precio" value="<?php echo number_format($producto['valor_minorista'], 0, ',', '.');?>" placeholder="999.999.999.999" onKeyUp="formatoMoneda(this, event)" maxlength="15">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="valormayorista">Valor Mayorista</label>
                                <input type="text" class="form-control" id="descuento" name="descuento" value="<?php echo number_format($producto['valor_mayorista'], 0, ',', '.');?>" placeholder="999.999.999.999" onKeyUp="formatoMoneda(this, event)" maxlength="15">
                            </div>
                        </div>
                    </div>
                </div> <!-- modal-body -->
