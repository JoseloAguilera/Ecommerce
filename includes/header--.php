...
?>
<header>
<div class="container-fluid d-xs-block d-sm-block d-md-none" style="position:fixed; z-index:999;" id="menu-top1">
	<div class="row">
		<div class="container"  >
...
<div class="container-fluid d-none d-lg-block d-md-block" style="position:fixed; z-index:999;" id="menu-top">
	<div class="row">
		<div class="container"  >
			<div class="row">
